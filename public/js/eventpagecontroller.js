		...
		$
				.each(
						...
						function(i, photo) {
							...
							var temp = 
								"<div>" +
									"<a class='magnifiable' href='"+ photo.url+ "'>" +
										...
										"<input class='check' value='11.jpg' id='delete_CheckBox' name='delete_CheckBox' type='checkbox' />" + 
										"<input class='check' name='delete_CheckBox' type='hidden' value='false' />" + 
										"</div>" +
									"</a>"+ 
								"</div>";
							...
							// style='width:"+w+"px; height: 200px;'>" +
							// "<img src='"+photo.url+"'><input value='11.jpg'
							// id='delete_CheckBox' name='delete_CheckBox'
							// type='checkbox' />" +
							// "<input name='delete_CheckBox' type='hidden'
							// value='false' />"+"</div>";
							// background-image: url("+photo.url+")'

							// "<div class='cell' style='width:"+w+"px; height:
							// 200px;'>" +
